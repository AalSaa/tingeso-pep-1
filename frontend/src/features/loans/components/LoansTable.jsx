...
export function LoanTable({ loans, fetchLoans, isSimulationPage }) {
    ...
    const LoanRow = ({ loan }) => {
        return (
            <tr className="odd:bg-white even:bg-slate-50">
                ...
                {isSimulationPage ? (
                    <td className="text-start p-4">${loan.monthly_fee}</td>
                ) : null}
                {isSimulationPage ? null : (
            ...
            <table className="w-full">
                <thead>
                    <tr className="bg-slate-50">
                        ...
                        {isSimulationPage ? (
                            <th className="text-start p-4">Cuota mensual</th>
                        ) : null}
                        {isSimulationPage ? null : (
